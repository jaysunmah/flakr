...
//        print(data[indexPath.row])
    ...
    func navigateViews(selectedView: String) {
        ...
        let tempDashBoardEventVC = DashBoardViewController()
        tempDashBoardEventVC.currClient = currClient
        
        if (selectedView == "dashboard") {
        evo_drawerController?.setCenterViewController(UINavigationController(rootViewController: tempDashBoardEventVC), withCloseAnimation: true, completion: nil)
